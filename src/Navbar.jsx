              ...
              return (
                <li key={item.href}>
                  ...
                  >
                    {item.label}
                    <span
                      className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-1 h-1 rounded-full bg-teal-500 transition-all duration-300 ${isActive ? "opacity-100 scale-100" : "opacity-0 scale-0"}`}
                    ></span>
                  </button>
                </li>
              );
